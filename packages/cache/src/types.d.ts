 ...
 */
export type SerializableValue = JsonValue | Date | Record<string, JsonValue> | Array<JsonValue> | object;
/**
 * Permissible data types passed to cache telemetry and logging methods.
 */
export type LoggableValue = string | number | boolean | Error | Record<string, string | number | boolean>;
/**
