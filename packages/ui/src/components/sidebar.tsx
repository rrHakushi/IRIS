...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 min-w-0 flex-col bg-background md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:rounded-2xl md:peer-data-[variant=inset]:shadow-xs md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:border-sidebar-border/80 md:peer-data-[side=left]:peer-data-[variant=inset]:ms-0 md:peer-data-[side=right]:peer-data-[variant=inset]:me-0 md:peer-data-[side=left]:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2 md:peer-data-[side=right]:peer-data-[variant=inset]:peer-data-[state=collapsed]:me-2",
        className
      )}
      {...props}
    />
