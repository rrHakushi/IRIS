...
export function PasswordCard({
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 pt-1">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <Input
              ...
              className="h-10 rounded-xl bg-background/70 pe-10 text-xs"
            />
            <button
              type="button"
              tabIndex={-1}
              ...
              className="absolute end-3 top-1/2 -translate-y-1/2 cursor-pointer p-1 text-muted-foreground transition-colors hover:text-foreground"
              aria-label={
        ...
        <div className="space-y-1">
          ...
          {(isNewPasswordFocused ||
            ...
            <div className="animate-in pt-1 duration-150 fade-in-50">
              <PasswordChecklist
                criteria={criteria}
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <Input
              ...
              className={cn(
                "h-10 rounded-xl bg-background/70 pe-10 text-xs",
                confirmPassword &&
                  !isMatch &&
      ...
      {hasInput && (
        <div className="flex animate-in items-center justify-end gap-2.5 pt-2 fade-in-50">
          <Button
            type="button"
            variant="ghost"
            size="sm"
          ...
          <Button
            ...
            size="sm"
            disabled={
              isSaving || !currentPassword || !isPasswordValid || !isMatch
            }
