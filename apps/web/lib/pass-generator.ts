...
export const DICEWARE_WORDS = [
  ...
  "actor", "actual", "adapt", "address", "admire", "advance", "advice", "affair", "afford", "afraid",
  "after", "again", "agent", "agree", "ahead", "airline", "airport", "alarm", "album", "alert",
  "alike", "alive", "allow", "almost", "alone", "along", "alpha", "already", "alter", "always",
  "amaze", "amber", "among", "amount", "anchor", "ancient", "angel", "anger", "animal", "annual",
  "answer", "antenna", "anxious", "anybody", "apart", "apology", "appear", "apple", "approve", "april",
  "arch", "arctic", "area", "arena", "argue", "armor", "army", "around", "arrange", "arrest",
  "arrive", "arrow", "artist", "artwork", "asleep", "aspect", "assault", "asset", "assist", "assume",
  ...
  "awkward", "axis", "baby", "bachelor", "bacon", "badge", "baggage", "balance", "balcony", "ball",
  "bamboo", "banana", "banner", "barber", "barely", "bargain", "barrel", "barrier", "base", "basic",
  "basket", "battle", "beach", "beacon", "bean", "beauty", "become", "beef", "before", "begin",
  "behave", "behind", "belief", "belong", "below", "bench", "benefit", "best", "betray", "better",
  "between", "beyond", "bicycle", "bid", "bike", "bind", "biology", "bird", "birth", "bitter",
  "black", "blade", "blame", "blanket", "blast", "bleak", "bless", "blind", "blood", "blossom",
  "blouse", "blue", "blur", "blush", "board", "boat", "body", "boil", "bomb", "bone",
  "bonus", "book", "boost", "border", "boring", "borrow", "boss", "bottom", "bounce", "boundary",
  "bracket", "brain", "branch", "brass", "brave", "bread", "breeze", "brick", "bridge", "brief",
  "bright", "bring", "brisk", "broad", "bronze", "brother", "brush", "bubble", "buddy", "budget",
  ...
  "scooter", "scope", "score", "scramble", "scream", "screen", "script", "scrub", "sea", "search",
  ...
  "toy", "track", "trade", "traffic", "train", "transfer", "trap", "trash", "travel", "tray",
  ...
  "walnut", "warm", "warn", "wash", "wasp", "waste", "water", "wave", "way", "wealth",
...
export function generatePassword(options: Partial<PasswordGeneratorOptions> = {}): string {
  ...
  if (opts.avoidAmbiguous) {
    const filterAmbiguous = (s: string) =>
      s.split("").filter((c) => !AMBIGUOUS_CHARS.includes(c)).join("")
 ...
 */
export function generateUsername(serviceName?: string, baseEmail?: string): string {
 ...
 */
export function calculatePasswordEntropy(password: string): PasswordEntropyScore {
  ...
  const entropyBits = Math.round(password.length * (Math.log(poolSize) / Math.LN2))
