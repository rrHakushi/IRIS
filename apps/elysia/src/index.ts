...
export type { StudioDetails, StudioCreationItem } from "./modules/IRIS-media/media/studios/[id]/types"
export type { StudioCreationsResponse } from "./modules/IRIS-media/media/studios/[id]/creations/types"
