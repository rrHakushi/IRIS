...
export default defineRoute({
  cacheKeys: {
    similar: {
      books: (id: number) => `books:${id}:similar`,
    },
  },
  ...
  schema: {
    ...
    detail: {
      ...
      description:
        "Finds similar books based on title (20 pts, >= 60% match), genres (1 pt each), and characters (0.5 pts each) with a minimum score of 17 points.",
      tags: ["Media - Books"],
    },
  },
