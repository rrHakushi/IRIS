export {
  SimilarMediaTitlesSchema as SimilarAnimeTitlesSchema,
  SimilarMediaItemSchema as SimilarAnimeItemSchema,
  SimilarMediaResponseSchema as SimilarAnimeResponseSchema,
