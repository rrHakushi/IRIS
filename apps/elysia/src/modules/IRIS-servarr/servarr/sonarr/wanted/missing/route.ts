...
export default defineRoute({
  GET: {
    schema: {
      ...
      detail: {
        summary: "Get Sonarr wanted missing episodes",
        description: "Fetches missing monitored episodes awaiting release.",
        tags: ["Servarr", "Sonarr"],
      },
    },
    ...
    async handler({ query, session, prisma }: any) {
      ...
      try {
        ...
        return {
          ...
          message:
            err.message ||
            "Failed to fetch wanted missing episodes from Sonarr",
        }
      }
    },
  },
