...
export default defineRoute({
  GET: {
    schema: {
      ...
      detail: {
        summary: "Get Radarr cutoff unmet movies",
        description:
          "Fetches movies whose file quality is below the profile cutoff.",
        tags: ["Servarr", "Radarr"],
      },
    },
    ...
    async handler({ query, session, prisma }: any) {
      ...
      try {
        ...
        return {
          ...
          totalRecords: 0,
          message:
            err.message || "Failed to fetch cutoff unmet movies from Radarr",
        }
      }
    },
  },
