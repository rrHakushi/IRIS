...
export default defineRoute({
  GET: {
    schema: {
      ...
      detail: {
        summary: "Scan Radarr manual import files",
        description:
          "Scans a folder or download for manual importing into Radarr.",
        tags: ["Servarr", "Radarr"],
      },
    },
  ...
  POST: {
    schema: {
      ...
      detail: {
        summary: "Execute Radarr manual import",
        description: "Imports selected files into Radarr.",
        tags: ["Servarr", "Radarr"],
      },
    },
