...
export default defineRoute({
  schema: {
    ...
    detail: {
      summary: "Fetch detailed statistics for user book list with optional rewind filters",
      tags: ["Lists - Book - Stats"],
    },
  },
  ...
  async GET({ params, query, prisma, session }) {
    ...
    const stats = await mediaStatsService.getBookStats(dbUser.id, isOwner, {
