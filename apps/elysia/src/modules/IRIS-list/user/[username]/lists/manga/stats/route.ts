...
export default defineRoute({
  schema: {
    ...
    detail: {
      summary: "Fetch detailed statistics for user manga list with optional rewind filters",
      tags: ["Lists - Manga - Stats"],
    },
  },
  ...
  async GET({ params, query, prisma, session }) {
    ...
    const stats = await mediaStatsService.getMangaStats(dbUser.id, isOwner, {
