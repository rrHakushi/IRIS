...
export default defineRoute({
  schema: {
    ...
    detail: {
      summary: "Fetch detailed statistics for user movie list with optional rewind filters",
      tags: ["Lists - Movie - Stats"],
    },
  },
  ...
  async GET({ params, query, prisma, session }) {
    ...
    const stats = await mediaStatsService.getMovieStats(dbUser.id, isOwner, {
