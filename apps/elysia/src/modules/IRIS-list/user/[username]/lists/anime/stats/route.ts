...
export default defineRoute({
  schema: {
    ...
    detail: {
      summary: "Fetch detailed statistics for user anime list with optional rewind filters",
      tags: ["Lists - Anime - Stats"],
    },
  },
  ...
  async GET({ params, query, prisma, session }) {
    ...
    const stats = await mediaStatsService.getAnimeStats(dbUser.id, isOwner, {
